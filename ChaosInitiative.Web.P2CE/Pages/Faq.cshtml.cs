    ...
    public class FaqModel : PageModel
    {
        ...
        public FaqModel()
        {
            faqs = new List<FaqElement>()
            {
                ...
                new FaqElement("When does P2CE release?", "We're currently aiming for the first quarter of 2021, but further delays may happen. Watch out for announcements on Discord or Twitter to stay up to date."),
