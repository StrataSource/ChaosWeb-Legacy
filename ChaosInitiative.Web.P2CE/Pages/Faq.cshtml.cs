    ...
    public class FaqModel : PageModel
    {
        ...
        public FaqModel()
        {
            faqs = new List<FaqElement>()
            {
                ...
                new FaqElement("How do I get access to the closed beta?", "You can't. The closed beta is only accessible to testers. Please be patient."),
                new FaqElement("When does P2CE release?", "We're currently aiming for Q1 2021, but further delays may happen. Watch out for announcements to stay up to date."),
